---
title: "Crithidia field flower data exploration brd est"
author: "Sonja"
date: "2/4/2022"
...
This is my THIRD attempt at data exploration for the Crithidia presence/absence and LOG10(crith infection counts) vs. farms, visit and field flower abundance. 

I am now using the data frame crit_ast_v1_brd_est.csv 
This data frame has the estimate for the border flowers for the farms where we did not estimate floral abundance for all 3 visits. 
...
I am using the "crit_ast_v1_brd_est.csv ". 

Here are values for the different variables in the "crit_ast_v1_brd_est.csv " dataframe 
...
crit_ast <- read.csv(here("data", "crit_ast_v1_brd_est.csv")) #dataframe with all cut flowers together
